        ...
        <div class="form-group table-responsive">
            ...
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="pr_id" Width="100%">
               ...
               <%--     <dx:GridViewDataColumn Caption="Mô tả Seo" FieldName="_description" HeaderStyle-HorizontalAlign="Center" Width="13%"></dx:GridViewDataColumn>--%>
                    <dx:GridViewDataColumn Caption="Sản Phẩm" FieldName="cate_name" HeaderStyle-HorizontalAlign="Center" Width="5%"></dx:GridViewDataColumn>
                            ...
                            <div class="div_content col-12">
                                <div class="col-12">
                                    <div class="col-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 form-control-label text-xs-right">Sản phẩm:</label>
                                            <div class="col-sm-8">
