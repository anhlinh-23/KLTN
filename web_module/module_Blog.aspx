<%@ Page Title="" Language="C#" MasterPageFile="~/Web_MasterPage.master" AutoEventWireup="true" CodeFile="module_Blog.aspx.cs" Inherits="web_module_module_Blog" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder5" runat="Server">
    ...
    <div style="background: #FFF">
        <div class="grid">
            <div class="c10"></div>
            <h1 class="title-home title-page"><a>Tin tức </a></h1>
            <div class="c10"></div>
            <div>
